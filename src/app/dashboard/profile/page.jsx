        ...
        if (data) {
          ...
          setTimeout(() => {
            ...
            if (document.getElementById("rate"))
              document.getElementById("rate").value = data.price_base || "";
          }, 0);
        }
      }
    ...
    <div className="max-w-3xl mx-auto py-12">
      <div className="mb-10 text-center md:text-left">
        ...
        <p className="text-slate-400 text-lg">
          {isEditing
            ? "Update your profile information and commission rates here."
            : "Complete your profile to start accepting commission requests through Sarena Escrow."}
        </p>
      </div>
        ...
        <CardContent className="p-8">
          <form onSubmit={handleSaveProfile} className="space-y-8">
            <div className="grid gap-8">
              ...
              <div className="space-y-3">
                <Label htmlFor="bio" className="text-slate-200 text-base">
                  Bio / About
                </Label>
                <Textarea
                  id="bio"
              ...
              <div className="space-y-3">
                <Label htmlFor="portfolio" className="text-slate-200 text-base">
                ...
                <p className="text-xs text-slate-500">
                  Provide a link where buyers can see more of your work.
                </p>
              </div>

              <div className="space-y-3">
                <Label htmlFor="rate" className="text-slate-200 text-base">
                  Base Commission Rate (IDR)
                </Label>
                ...
                <p className="text-xs text-slate-500 italic mt-2">
                  * Sarena takes a fixed 10% platform fee upon successful
                  completion.
                </p>
              </div>
            </div>
            ...
            <div className="pt-8 border-t border-white/5 flex flex-col sm:flex-row gap-4 justify-end">
              ...
              <Button
                type="submit"
                variant="gradient"
                className="px-10 rounded-xl h-12 font-bold shadow-lg shadow-indigo-500/20"
                disabled={loading}
              >
                {loading
                  ? "Saving..."
