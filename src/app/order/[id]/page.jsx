...
export default function CheckoutPage({ params }) {
  ...
  if (error && !creator)
    return <div className="text-center py-24 text-rose-400">{error}</div>;
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      <div className="mb-10 text-center md:text-left">
        ...
        <p className="text-slate-400 text-lg">
          Your payment will be held securely until you approve the final
          delivery from the creator.
        </p>
      </div>
      ...
      <Card className="glass rounded-3xl border-white/10 shadow-2xl bg-slate-900/40 backdrop-blur-xl overflow-hidden">
        <CardHeader className="border-b border-white/5 bg-white/[0.02] p-8">
          ...
          <CardDescription>
            Review the details of your commission request.
          </CardDescription>
        </CardHeader>
